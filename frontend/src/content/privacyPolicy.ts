...
export const PRIVACY_POLICY_SECTIONS: PolicySection[] = [
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        text: 'If you do not agree to the terms of this Privacy Policy, please do not access or use EPAM websites. If you wish to stop receiving EPAM marketing materials then please click on the Unsubscribe button within the marketing email you have received from us.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        text: 'EPAM collects information to provide better services to its users and to better understand the visitors to its websites and what content is of interest to them. EPAM collects information in the following ways:',
      },
      {
        type: 'list',
        items: [
          ...
          'EPAM collects technical data from various third parties and public sources, such as analytics providers, advertising networks, and search information providers.',
        ],
      },
      {
        type: 'paragraph',
        text: 'Other than as required by law, EPAM websites do not collect any special categories of personal information about you (this includes details about your race or ethnicity, religious or philosophical beliefs, sex life, sexual orientation, political opinions, trade union membership, information about your health and genetic and biometric data). EPAM will not collect any information about criminal convictions and offences.',
      },
      {
        type: 'paragraph',
        text: 'EPAM will only use your personal information for the purposes for which it was collected, unless it reasonably considers that it needs to use it for another reason that is compatible with the original purpose. If EPAM needs to use your personal information for an unrelated purpose, EPAM will notify you and explain the legal basis which allows EPAM to do so.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        text: 'EPAM may disclose your personal information to the following categories of recipients:',
      },
      {
        type: 'list',
        items: [
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        text: "If your personal information is protected by EU data protection law, EPAM's legal basis for collecting and using the personal information described above will depend on the personal information concerned and the specific context in which EPAM collects it.",
      },
      {
        type: 'paragraph',
        text: 'However, EPAM will normally collect personal information from you only (a) where it needs the personal information to perform a contract with you, (b) where the processing is in its legitimate interests and is not overridden by your rights, or (c) where it has your consent to do so. In some cases, EPAM may also have a legal obligation to collect personal information from you or may otherwise need the personal information to protect your vital interests or those of another person.',
      },
      {
        type: 'paragraph',
        text: 'If you have questions about or need further information concerning the legal basis on which EPAM collects and uses your personal information, please contact EPAM using the contact details provided under the "Contact Details" heading below.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        text: 'If your personal information is protected by EU data protection law, you have the following data protection rights which you may be able to exercise by contacting EPAM using the contact details provided under the "Contact Details" heading below:',
      },
      {
        type: 'list',
        items: [
          'If you wish to request deletion of your personal information, you can do that in the Settings of your profile on Profile.epam.com.',
          'If you wish to access, correct, update your personal information, you can do so at any time by contacting EPAM.',
      ...
      {
        type: 'paragraph',
        text: 'You will not have to pay a fee to access your personal information (or to exercise any of the other rights). However, EPAM may charge a reasonable fee or refuse to comply with your request if your request is clearly unfounded, repetitive or excessive. EPAM tries to respond to all legitimate requests within one month. Occasionally, it may take longer if your request is particularly complex or you have made a number of requests. In this case, EPAM will notify you and keep you updated.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        text: "You can set your browser to refuse all or some browser cookies, or to alert you when websites set or access cookies. If you disable or refuse cookies some parts of EPAM websites may become inaccessible or not function properly. For more information about the cookies that EPAM uses, please see EPAM's Cookie Policy.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        text: 'EPAM reserves the right to modify or amend this Privacy Policy at its own discretion from time to time. The changes can be viewed here or elsewhere on EPAM websites. Your continued use of EPAM websites constitutes your acceptance of those changes.',
      },
      {
        type: 'paragraph',
        text: 'This version was last updated on 06 July 2018 and historic versions can be obtained by contacting EPAM.',
      },
    ],
  },
  {
    ...
    blocks: [
      {
        type: 'paragraph',
        text: 'It is important that the personal information EPAM holds about you is accurate and current. Please keep EPAM informed if your personal information changes during your relationship with EPAM. Additionally, if you have any questions about this Privacy Policy, the practices of EPAM websites or your interaction with EPAM via EPAM websites, please contact:',
      },
      {
        type: 'paragraph',
        text: 'EPAM Systems, Inc.\n41 University Drive, Suite 202\nNewtown, PA 18940\nP: +1-267-759-9000\nF: +1-267-759-8989\nE: privacy@epam.com',
      },
    ],
  },
]
